...
<prompt xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance"
        xsi:noNamespaceSchemaLocation="https://jabrena.github.io/pml/schemas/0.6.0/pml.xsd">
...
<pml-workflow xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance"
              xsi:noNamespaceSchemaLocation="https://jabrena.github.io/pml/schemas/0.6.0/pml-workflow.xsd">
...
```bash
./mvnw clean package
java -jar cli/target/pml-to-md-0.6.0.jar --help
java -jar cli/target/pml-to-md-0.6.0.jar validate cli/src/test/resources/pml/pml-hello-world.xml
java -jar cli/target/pml-to-md-0.6.0.jar convert cli/src/test/resources/pml/pml-hello-world-template.xml --template MESSAGE "Hello World"
java -jar cli/target/pml-to-md-0.6.0.jar convert cli/src/test/resources/pml/pml-hello-world-template-multiple.xml --template MESSAGE "Hello World" CHANNEL "Console"
```
