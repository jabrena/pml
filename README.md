...
java -jar cli/target/pml-to-md-0.4.0-SNAPSHOT.jar validate --file cli/src/test/resources/pml/pml-hello-world.xml
java -jar cli/target/pml-to-md-0.4.0-SNAPSHOT.jar validate --file cli/src/test/resources/pml/invalid-pml.xml
```
